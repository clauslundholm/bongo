    ...
    <section className="bg-bongo-black bg-logo-pattern section-pad">
      <div className="mx-auto max-w-5xl">
        <div className="text-center">
          <h1 className="text-5xl sm:text-7xl text-white text-stroke-white">{dict.contact.title}</h1>
          <p className="mx-auto mt-4 max-w-xl font-body text-white/80 text-lg">{dict.contact.sub}</p>
        </div>
